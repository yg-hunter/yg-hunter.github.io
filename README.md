...
***
<h1 id="1.14">LeetCode 188</h1>  [回到目录](#0)  
## 14 [买卖股票的最佳时机Ⅳ best time to buy and sell stock](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-iv/)    
...
## 14.2 解题思路   
本题是买卖股票系列的第三题，跟前两题不同之处在于，本题限定**最多只能交易k次**，同样用动态规划解法，下面我们就来重点分析下动态规划。   
